    ...
    <div class="content container-fluid">
        ...
        <div class="row mt-1">
            <div class="col">
                ...
                <?php
                $artOBJ = new  ARTICLE();
               $articles = $artOBJ->getArtUnverified();
                ?>
                    ...
                    echo '<tr> <td colspan="6" class="text-center">All posts have been  <strong>VERIFIED</strong>. Please check later </td></tr>';
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="unverified.php?id=<?php  echo $article['article_id']; ?>"
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer p-1" style="background-color:  #f6dffa;">
                ...
                <button type="submit" class="btn btn-success btn-sm" form="userEditpost" name="verify_article">Verify</button>
            </div>
        </div>
    </div>
</div>
