...
$error = '';
    ...
    if (isset($_POST['comment_content'])) {
        ...
        echo $output;
    } elseif (isset($_POST['commentcount'])) {
        $articleid = $_POST['commentcount'];

       $commnets_count =  $artOBJ->countSpecific( "article_comment_fk_article_id", "article_comments", $articleid);
       echo $commnets_count[0] ;
